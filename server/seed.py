...
if __name__ == '__main__':
    with app.app_context():
        ...
        items.append(i)
        i = Item(name="Sarumon Statue", description="Some slight damage", price= 50, img_url="https://images.fun.com/products/72113/1-2/lord-of-the-rings-saruman-the-white-miniature-statue.jpg", item_user_id=2)
        items.append(i)
        ...
        items.append(i)
        i = Item(name="Captain America statue", description="Like new", price= 75, img_url="https://cdn.marvel.com/content/1x/pcs-captain-america-2.jpg", item_user_id=3)
        items.append(i)
        ...
        items.append(i)
        i = Item(name="Hogwarts Watch", description="Lightly used", price= 475, img_url="https://www.rollingstone.com/wp-content/uploads/2022/10/FSL4929862_HOL22_AD_25.jpeg?w=1581&h=1054&crop=1", item_user_id=6)
        items.append(i)
        ...
        items.append(i)
        i = Item(name="Darth Vader statue", description="Near-mint", price= 150, img_url="https://m.media-amazon.com/images/I/21DFM86CYPL._AC_UF894,1000_QL80_.jpg", item_user_id=1)
        items.append(i)
