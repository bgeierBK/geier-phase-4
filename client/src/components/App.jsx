  ...
  return (
    ...
    <div className='App'>
      ...
      <h1 style={{
        ...
        <Navbar/>
      <Outlet context={{collections:collections, users: users, currentUser:currentUser, setCurrentUser:setCurrentUser, cartItems: cartItems, setCartItems: setCartItems, handleAddToCart: handleAddToCart}} />
